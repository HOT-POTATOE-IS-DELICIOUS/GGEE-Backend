...
public class ErrorCodeHttpStatusMapper {
    ...
    public HttpStatus toHttpStatus(ErrorCode errorCode) {
        return switch (errorCode) {
            case EXPIRED_TOKEN, EXPIRED_REFRESH_TOKEN, INVALID_EMAIL_OR_PASSWORD, SESSION_EXPIRED, INVALID_SESSION -> HttpStatus.UNAUTHORIZED;
            case INVALID_TOKEN, INVALID_TOKEN_TYPE, INVALID_EMAIL_FORMAT -> HttpStatus.BAD_REQUEST;
            case EMAIL_ALREADY_EXISTS -> HttpStatus.CONFLICT;
            case ISSUE_GRAPH_SERVICE_UNAVAILABLE, AUDIT_SERVICE_UNAVAILABLE, STRATEGY_AI_SERVICE_UNAVAILABLE -> HttpStatus.SERVICE_UNAVAILABLE;
